...
# MAGIC
# MAGIC
# MAGIC 1. Download the [Product Description](https://github.com/julie-nguyen-ds/asean-workshops-2024/blob/main/Datasets/DI%20Platform%20Lab/product_description.tsv) file to your local computer <br />
# MAGIC 2. Navigate to the `Catalog Explorer` and find the `byo_data` volume under your catalog and schema
# MAGIC <br /><img style="float:right" src="https://github.com/julie-nguyen-ds/asean-workshops-2024/blob/main/Resources/Screenshots/1.2.png?raw=true"/><br />
...
# MAGIC <br /><img style="float:right" src="https://github.com/julie-nguyen-ds/asean-workshops-2024/blob/main/Resources/Screenshots/1.5.png?raw=true"/><br />
